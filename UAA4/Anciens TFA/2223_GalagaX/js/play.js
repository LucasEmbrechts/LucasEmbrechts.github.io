...
function checkVies() {
    if(localStorage.getItem("imgVaisseau") === '../sources/bleu_v1.png'){//regarder de l'image du vaisseau
        vies = 1; //ajouter le nombre de vies qu'il aura et qui changeront en fonction des colisions et en fonction de l'image du vaisseau dans le local storage
        viesMax = 1;//ajouter le nombre de vies maximum qu'il aura en fonction de l'image du vaisseau
    }else if(localStorage.getItem("imgVaisseau") === '../sources/bleu_v2.png'){//sinon, la même chose en fonction d'autre images du vaisseau dans le local storage
        vies = 2; 
        viesMax = 2; 
...
if(localStorage.getItem("imgVaisseau") == null){//si il n'y a pas de d'image de vaisseau dans le localStorage ,
    localStorage.setItem("imgVaisseau","../sources/bleu_v1.png")//mettre l'image de base dans le localStorage
}
fleche.src = localStorage.getItem("imgVaisseau");//et mettre l'image du localStorage comme image 

checkVies();//regarder le vies
...
brique.src="../sources/caillou.png";


var c = document.getElementById("mon_canvas");
var ctx= c.getContext("2d");
var countscore = setInterval(stellars, 1000);//points
//var de la souris
var positionX = 500;
var positionY = 650;
...
function draw(){
    ...
    if( briques["brique"+i]["posx"] < positionX + 70 &&
        ...
        briques["brique"+i]["posy"] > positionY - 80){
            ...
            let barreVie = document.getElementById("healthBarTwo");//recevoir la div du HTML au JavaScript 
            ...
            if (vies < 0) {//condition si les vies sonts inferieures a 0,
                ...
                let sizebarre = Math.round(vies * 100/viesMax);//calcul, (math.round = arrondir la reponse) les vies fois 100 divisés par le maximum de vies du vaisseau
                barreVie.style.width = sizebarre + "%"//et cette reponse dit combien de pourcent la largeur de la barre fera
            } 
    }
        //fin du code de Ferre Ilegems
...
function avancer() {
    ...
    //deux=Math.floor(Math.random() * 10)
...
function menu() {
    document.getElementById("button_menu");//recevoir le bouton du HTML au Javaµscript
