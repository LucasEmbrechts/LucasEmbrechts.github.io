...
var dico=    ['HARIBOT','NIKE','PUMA','MILKA','LAROUSSE','APPLE',
              'BIC','LOTUS','YAMAHA','SONY','NINTENDO'];

//tableau des indices par apport au mot à trouver
var indices=    ["L'indice est : je suis pour les grands et les petits",
                 "L'indice est : mon logo ressemble à un V penché",
                 "L'indice est : je suis un animal",
                 "L'indice est : ma mascotte est blanche et mauve",
                 "L'indice est : on me parcours à la recherche de mot",
                 "L'indice est : une pomme",
                 "L'indice est : on m'utilise pour écrire",
                 "L'indice est : je porte le nom d'une collation",
                 "L'indice est : moto,quad",
                 "L'indice est : PS4",
                 "L'indice est : on m'utilise pour jouer a mario",];
var nbAleat = aleat();
