...
var dico=    ['POIREAU','COURGETTE','CAROTTE','HARICOT','EPINARD','SALADE',
            'TOMATE','RADIS','COMCOMBRE','AUBERGINE'];

//tableau des indices par apport au mot à trouver
var indices=    ["L'indice est : ma racine est blanche mais mon extrémité est verte",
                 "L'indice est : je suis principalement vert mais je peux aussi être jaune",
                 "L'indice est : je pousse dans la terre mais mes feuilles resortent de la terre",
                 "L'indice est : on peux me planter ici en belgique",
                 "L'indice est : les enfants ne m'aiment souvent pas dans leurs assiettes",
                 "L'indice est : les lapins me trouvent bonne à manger",
                 "L'indice est : rouge comme ...",
                 "L'indice est : je me vends généralement en botte",
                 "L'indice est : je ressemble à une courgette",
                 "L'indice est : je suis mauve",];
var nbAleat = aleat();
