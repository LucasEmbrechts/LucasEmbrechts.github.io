...
var dico=    ['BELGIQUE','RUSSIE','ITALIE','MEXIQUE','AUSTRALIE','NORVEGE',
            'CANADA','SUISSE','CHINE','JAPON','FRANCE','THAILANDE','POLOGNE','MALTE','PORTUGAL'];

//tableau des indices par apport au mot à trouver
var indices=    ["L'indice est : frites",
                 "L'indice est : poutine",
                 "L'indice est : spaghetti",
                 "L'indice est : moustache, tacos",
                 "L'indice est : je possède des kangourous",
                 "L'indice est : pays nordique de l'europe",
                 "L'indice est : le pays du sirop d'érable",
                 "L'indice est : pays des yaourts",
                 "L'indice est : on mange du chien",
                 "L'indice est : sushi",
                 "L'indice est : baguette",
                 "L'indice est : on mange du riz",
                 "L'indice est : on mange de la goulache",
                 "L'indice est : je suis le plus petit de l'europe",
                 "L'indice est : maçons",];
var nbAleat = aleat();
